"""Build the section- and language-refined Geoscience Frontiers manuscript v4 DOCX."""
...
PAPER = PROJECT / "FINAL PAPER" / "Manuscript_single_file" / "v4_2026-07-28"
SOURCE = PAPER / "manuscript_v4_source.md"
OUTPUT = Path(
    os.environ.get(
        "CPEC_V4_OUTPUT",
        str(PAPER / "CPEC_manuscript_v4_section_and_language_refined_2026-07-28.docx"),
    )
)
FIGURES = Path(os.environ.get("CPEC_V4_FIGURES_DIR", str(PAPER / "figures")))
