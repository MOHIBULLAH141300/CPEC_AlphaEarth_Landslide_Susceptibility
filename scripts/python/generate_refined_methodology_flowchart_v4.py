"""Generate a compact publication-ready methodology flowchart for manuscript V4."""
...
def build() -> None:
    ...
    rounded_box(
        ...
        orange,
        "Robustness",
        "Matched controls\nTypology + road ablation",
    )

    # Phase 5
    y5, h5 = 0.088, 0.132
    green, green_pale = phase_container(ax, y5, h5, 5, "TRANSFERABILITY AND APPLICATION", "green")
    ...
    rounded_box(
        ...
        "Three 250 m score maps | transfer and AoA diagnostics |\n"
